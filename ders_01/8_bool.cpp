...
// and in stdboo.h bool is defined as _Bool, and true is defined as 1 , false is defined as 0
// also comparing and logical operators results in integer value of 1 or 0 in c
...
int main() {
	...
	// in cpp there is automatic conversion from integer types to booland and vice versa
	int x = 5, y = -5, z = 0;
